...
export const ScrollStackItem = ({ children, itemClassName = '' }: { children: React.ReactNode; itemClassName?: string }) => (
  <div
    className={`scroll-stack-card relative w-full min-h-[20rem] my-8 p-8 md:p-12 rounded-3xl md:rounded-[40px] shadow-[0_0_30px_rgba(0,0,0,0.1)] box-border origin-top will-change-transform ${itemClassName}`.trim()}
      style={{
        backfaceVisibility: 'hidden',
        transformStyle: 'preserve-3d',
        transition: 'transform 0.15s cubic-bezier(0.25, 0.46, 0.45, 0.94), filter 0.15s cubic-bezier(0.25, 0.46, 0.45, 0.94)'
      }}
  >
    {children}
  </div>
...
const ScrollStack = ({
  ...
  return (
    <div className={containerClassName} ref={scrollerRef} style={containerStyles}>
      <div className="scroll-stack-inner px-4 md:px-20 pb-48">
        {children}
